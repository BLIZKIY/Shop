...
class CartController
{
        public function actionAdd($id) {
            ...
            //добавляэм товар в корзину
            Cart::addProduct($id);

            //возвращаем пользователя на страницу
            $referrer = $_SERVER['HTTP_REFERER']; //узнаем страницу с которой пришел пользователь
            header("Location: $referrer"); // возвращаем пользователя обратно
